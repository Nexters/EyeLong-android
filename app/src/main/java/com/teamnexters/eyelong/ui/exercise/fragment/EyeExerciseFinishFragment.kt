 ...
 * Use the [EyeExerciseFinishFragment.newInstance] factory method to
...
class EyeExerciseFinishFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EyeExerciseFinishFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EyeExerciseFinishFragment().apply {
